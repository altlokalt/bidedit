    ...
    <>
      <div className="bg-black_900 flex font-sora items-center justify-end mx-[auto] w-[100%]">
        <div className="flex flex-col items-center justify-end w-[100%]">
          ...
          <div className="font-fractul h-[1677px] md:h-[3015px] sm:h-[4401px] md:px-[20px] relative w-[100%]">
            <div className="flex flex-col md:gap-[40px] gap-[99px] h-[100%] items-center justify-start m-[auto] w-[100%]">
              <div className="sm:h-[1960px] md:h-[2359px] h-[962px] relative w-[100%]">
                <div className="flex flex-col md:gap-[40px] gap-[62px] h-[100%] sm:hidden items-center justify-start m-[auto] w-[91%]">
                  ...
                  <div className="flex flex-col gap-[40px] sm:hidden items-start justify-start max-w-[1520px] w-[100%]">
            ...
            <div className="absolute bg-yellow_51 flex flex-col font-sansita gap-[24px] sm:hidden inset-x-[0] items-center justify-start mx-[auto] pb-[32px] pt-[24px] sm:px-[20px] px-[24px] top-[18%] sm:w-[100%] w-[480px]">
              <div className="flex flex-row items-center justify-between w-[100%]">
                <Text
              ...
              <div className="flex flex-col font-poppins relative w-[100%]">
                <div className="flex flex-1 flex-col gap-[8px] items-start justify-start mx-[auto] w-[100%]">
                  <Text
                  ...
                  <div className="border-[1px] border-gray_802 border-solid flex flex-col items-start justify-start w-[100%] sm:w-[100%]">
                    <div className="h-[128px] relative w-[100%]">
                      ...
                      <div className="absolute flex flex-col gap-[8px] inset-x-[0] items-start justify-start mx-[auto] top-[13%] w-[100%] sm:w-[100%]">
                        <Text
                          className="font-normal not-italic text-green_500 text-left w-[auto]"
                          variant="body6"
                        >
                    ...
                    <div className="h-[124px] sm:h-[207px] relative w-[100%]">
                      <div className="flex h-[100%] items-center justify-start m-[auto] w-[100%]">
                        <div className="flex flex-col items-center justify-start w-[100%]">
                          <div className="bg-yellow_50 flex items-start justify-start p-[16px] w-[100%]">
                            <div className="flex items-start justify-start my-[4px] w-[auto]">
                          ...
                          <div className="bg-yellow_50 flex items-start justify-start p-[16px] w-[100%]">
                            <div className="flex items-start justify-start mt-[4px] w-[auto]">
                              <Text
                                className="font-normal not-italic text-gray_802 text-left w-[auto]"
                                variant="body6"
                              >
                      ...
                      <div className="absolute flex flex-col gap-[8px] inset-x-[0] items-start justify-start mx-[auto] top-[0] w-[100%] sm:w-[100%]">
                        <Text
                          className="font-normal not-italic text-green_500 text-left w-[auto]"
                          variant="body6"
                        >
                ...
                <div className="flex flex-1 flex-col gap-[8px] items-center justify-start mt-[-12.56px] mx-[auto] w-[100%] z-[1]">
                  <div className="flex items-start justify-start w-[100%]">
...
export default ConnectWalletOnePage;
