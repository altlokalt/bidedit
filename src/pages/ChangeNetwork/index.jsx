...
const ChangeNetworkPage = () => {
  ...
  return (
    <>
      <div className="bg-black_900 flex font-sora items-start justify-end mx-[auto] pr-[112px] sm:pr-[20px] md:pr-[40px] w-[100%]">
        <div className="flex flex-col items-center justify-end w-[100%]">
          ...
          <div className="font-fractul sm:h-[1960px] md:h-[2359px] h-[984px] relative w-[100%]">
            <div className="absolute sm:h-[1960px] md:h-[2359px] h-[962px] inset-[0] justify-center m-[auto] w-[100%]">
                      ...
                      <div className="bg-gray_900 flex flex-row gap-[8px] items-center justify-start p-[16px] rounded-[12px] w-[100%]">
                        ...
                        <div className="md:h-[64px] h-[67px] relative w-[91%]">
                          ...
                          <Img
                            ...
                            className="absolute bottom-[0] h-[24px] right-[3%] w-[24px]"
                            alt="cursor"
                          />
                        </div>
                      </div>
            ...
            <div className="absolute bg-yellow_51 bottom-[0] flex flex-col font-sansita gap-[24px] h-[819px] md:h-[auto] items-center justify-start pb-[32px] pt-[24px] sm:px-[20px] px-[24px] right-[28%] sm:w-[100%] w-[558px]">
                  ...
                  <div className="flex items-start justify-start p-[16px] w-[100%]">
                    <div className="flex flex-col gap-[6px] items-center justify-start w-[100%]">
                      <div className="flex sm:flex-col flex-row gap-[13px] items-start justify-between w-[100%]">
                        <div className="flex sm:flex-1 flex-row gap-[8px] items-center justify-between sm:w-[100%] w-[478px]">
          ...
          <div className="flex flex-col font-fractul gap-[40px] items-start justify-start max-w-[1520px] mt-[77px] w-[100%]">
            <div className="flex flex-row md:gap-[40px] items-center justify-between w-[100%]">
              <Text
                className="font-bold text-left text-white_A700 w-[auto]"
                as="h2"
          ...
          <div className="flex flex-col font-sora gap-[40px] items-start justify-start max-w-[1520px] mt-[72px] w-[100%]">
