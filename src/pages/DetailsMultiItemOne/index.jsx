        ...
        <div className="flex flex-col items-center justify-start max-w-[1680px] mx-[auto] md:px-[20px] w-[100%]">
          ...
          <div className="flex md:flex-col flex-row font-plusjakartasans md:gap-[40px] items-center justify-between mt-[47px] md:w-[100%] w-[95%]">
            ...
            <div className="flex flex-col md:gap-[40px] gap-[95px] sm:hidden justify-start md:w-[100%] w-[24%]">
              <div className="flex flex-col items-start justify-start md:ml-[0] ml-[12px] md:w-[100%] w-[97%]">
          ...
          <div className="flex font-urbanist items-center justify-start mt-[115px] md:w-[100%] w-[92%]">
            <div className="flex flex-col items-start justify-start w-[100%]">
              <Text
          ...
          <div className="flex flex-col font-montserrat gap-[32px] items-start justify-start max-w-[1520px] mt-[117px] w-[100%]">
            <Text
          ...
          <div className="flex flex-col font-montserrat gap-[40px] items-start justify-start max-w-[1520px] mt-[79px] w-[100%]">
            <Text
              className="font-bold text-left text-white_A700 w-[auto]"
              as="h6"
              variant="h6"
          ...
          <div className="font-montserrat h-[1294px] mt-[20px] relative w-[100%]">
            <div className="flex font-urbanist items-center justify-start mb-[-133.75px] mx-[auto] w-[92%] z-[1]">
              <div className="flex flex-col items-start justify-start w-[100%]">
                <Text
                  className="font-semibold text-left text-white_A700 tracking-[0.34px] w-[auto]"
                  as="h2"
            ...
            <div className="bg-black_904 flex sm:hidden items-center justify-end mt-[auto] mx-[auto] p-[41px] sm:px-[20px] md:px-[40px] w-[100%]">
...
export default DetailsMultiItemOnePage;
